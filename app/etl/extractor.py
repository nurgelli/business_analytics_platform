...
class DataExtractor:
    ...
    def extract_csv(self) -> pd.DataFrame:
        ...
        try:
            for encoding in ("utf-8", "utf-8-sig", "cp1252", "latin1"):
                try:
                    ...
                    logger.info(f"CSV loaded successfully with {encoding}: {len(self.df)} rows")
                    return self.df
        ...
        raise UnicodeDecodeError("csv", b"", 0, 1, f"Unable to decode {self.file_path} with supported encodings", )
